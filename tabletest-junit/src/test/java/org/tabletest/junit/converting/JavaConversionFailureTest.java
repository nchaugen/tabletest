...
public class JavaConversionFailureTest {
    ...
    @TableTest("""
        ...
        A word that is not true or false | yes         | boolean                             | Built-in conversion of value "yes" to type boolean failed. Are you missing a type converter for this conversion?
