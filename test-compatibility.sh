...
#   TABLETEST_VERSION="0.5.9-SNAPSHOT"  # default TableTest version (can be overridden via env)
# Usage examples:
...
#   TABLETEST_VERSION="0.5.9-SNAPSHOT" ./test-compatibility.sh
...
if [ -z "$TABLETEST_VERSION" ]; then TABLETEST_VERSION="0.5.9-SNAPSHOT"; fi
