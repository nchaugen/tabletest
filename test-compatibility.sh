...
#   TABLETEST_VERSION="0.5.4-SNAPSHOT"  # default TableTest version (can be overridden via env)
# Usage examples:
...
#   TABLETEST_VERSION="0.5.4-SNAPSHOT" ./test-compatibility.sh
...
if [ -z "$JUNIT_VERSIONS" ]; then JUNIT_VERSIONS="6.0.0 5.14.0 5.13.4 5.12.2 5.11.0"; fi
...
if [ -z "$TABLETEST_VERSION" ]; then TABLETEST_VERSION="0.5.4-SNAPSHOT"; fi
