...
#   TABLETEST_VERSION="0.5.8-SNAPSHOT"  # default TableTest version (can be overridden via env)
# Usage examples:
...
#   TABLETEST_VERSION="0.5.8-SNAPSHOT" ./test-compatibility.sh
...
if [ -z "$SPRINGBOOT_VERSIONS" ]; then SPRINGBOOT_VERSIONS="4.0.0 3.5.7 3.4.0"; fi
if [ -z "$TABLETEST_VERSION" ]; then TABLETEST_VERSION="0.5.8-SNAPSHOT"; fi
